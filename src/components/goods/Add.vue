<template>
  <div>
    ...
    <!-- 卡片视图区 -->
    <el-card>
      <el-alert title="添加商品基本信息" type="info" center show-icon :closable="false"></el-alert>
      <el-steps :space="200" :active="activeIndex - 0" align-center>
        <el-step title="基本信息" icon="el-icon-s-order"></el-step>
        <el-step title="商品参数" icon="el-icon-s-claim"></el-step>
        <el-step title="商品属性" icon="el-icon-s-finance"></el-step>
        <el-step title="商品图片" icon="el-icon-picture"></el-step>
        <el-step title="商品内容" icon="el-icon-s-shop"></el-step>
    ...
    <!-- 图片预览弹框 -->
    <el-dialog title="图片预览" :visible.sync="pictureVisible" width="50%">
