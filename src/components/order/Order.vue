  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="orderList" style="width: 100%" border stripe>
        ...
        <el-table-column prop="order_price" label="订单价格" width="width"></el-table-column>
        ...
        <el-table-column label="操作" width="width">
          <template>
            ...
            <el-button type="success" icon="el-icon-location" size="small" @click="showProcessBox"></el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页区 -->
    ...
    <el-dialog title="添加分类" :visible.sync="addAddressVisible" width="30%" @close="addAddressClose">
      <!-- 主体区域 -->
      <el-form
        label-width="100px"
        ref="addressFormRef"
        ...
        status-icon
      >
        <el-form-item label="省/市地址">
          <el-cascader clearable v-model="addressForm.address1" :options="cityData"></el-cascader>
        </el-form-item>
